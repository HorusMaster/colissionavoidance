...
class Camera(SingletonConfigurable):
    ...
    def _gst_str(self):       
        ...
        return 'rtspsrc location=rtsp://admin:admin@192.168.0.150:554/cam/realmonitor?channel=1&subtype=1 ! decodebin ! nvvidconv ! video/x-raw, width=(int)%d, height=(int)%d, format=(string)BGRx ! videoconvert ! appsink' % (self.width, self.height)
